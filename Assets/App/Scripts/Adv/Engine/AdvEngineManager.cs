...
namespace Adv.Engine
{
	...
	/// アドベンチャーViewにアタッチさせる
	/// </remark>     
	public class AdvEngineManager : MonoBehaviour
	{
		...
		[SerializeField] private AdvView _view = null;
		...
		public static AdvEngineManager Instance { get; private set; }
		...
		/// キャラ管理者
		/// </summary>
		public Chara.AdvCharaManager Chara { get; private set; } = new Chara.AdvCharaManager();
		...
		public Window.AdvWindowView Win { get { return _view.Win; } }
